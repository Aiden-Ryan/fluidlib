...
SS316 = Material(density=800, TS=580, YS=290, E=193, Charpy=105, Izod=129, resitivity=7.4e-5, magneticPermeability=1.008, specificHeatCapacity=500, k = 16.3, CTE20C = 16, CTE250C = 16.2, CTE500C = 17.5, meanMeltingPoint=1385)
Al6061 = Material(density=270, TS=310, YS=276, BS=607, E=68.9, poissonsRatio=0.33, shearStrength= 207, resitivity=3.99e-6, specificHeatCapacity=896, k = 167, meanMeltingPoint=617)
